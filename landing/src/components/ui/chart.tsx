...
type ChartTooltipContentProps = React.ComponentProps<'div'> & {
  ...
  payload?: AnyPayload[];
  label?: string;
  labelFormatter?: (value: unknown, payload: AnyPayload[]) => React.ReactNode;
  labelClassName?: string;
  formatter?: (value: number, name: string, item: AnyPayload, index: number, payload: AnyPayload[]) => React.ReactNode;
  color?: string;
  hideLabel?: boolean;
